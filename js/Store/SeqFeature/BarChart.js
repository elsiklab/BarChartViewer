define('BarChartViewer/Store/SeqFeature/BarChart', [
            'dojo/_base/declare',
            'dojo/_base/lang',
            'dojo/_base/array',
            'dojo/Deferred',
...
return declare([ SeqFeatureStore, DeferredFeatures, DeferredStats, GlobalStatsEstimationMixin, RegionStatsMixin ],
 ...
 /**
  * @lends JBrowse.Store.SeqFeature.BarChart
  */
{
    /* Adapted from JBrowse/Store/SeqFeature/BED */
	...
	console.log("Loading BarChart features");
        var thisB = this;
